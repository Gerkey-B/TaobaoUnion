...
public class ScrollingUtil {
    ...
    public static boolean isViewToBottom(View view, int mTouchSlop) {
        ...
        if (view instanceof TbNestedScrollView) {
            return isTbNestedScrollViewBottom((TbNestedScrollView) view);
        }
    ...
    private static boolean isTbNestedScrollViewBottom(TbNestedScrollView view) {
